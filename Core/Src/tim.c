...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM12_MspInit 0 */
    ...
    PB14     ------> TIM12_CH1
    */
    GPIO_InitStruct.Pin = sonar4_Echo_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF9_TIM12;
    HAL_GPIO_Init(sonar4_Echo_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM12_MspDeInit 0 */
    ...
    PB14     ------> TIM12_CH1
    */
    HAL_GPIO_DeInit(sonar4_Echo_GPIO_Port, sonar4_Echo_Pin);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA6     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(sonar1_Echo_GPIO_Port, sonar1_Echo_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD12     ------> TIM4_CH1
    */
    HAL_GPIO_DeInit(sonar2_Echo_GPIO_Port, sonar2_Echo_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA2     ------> TIM5_CH3
    */
    HAL_GPIO_DeInit(sonar3_Echo_GPIO_Port, sonar3_Echo_Pin);
...
void delay_us(uint32_t nus)
{
	...
	ticks=nus*(SystemCoreClock/1000000); 	//�?要的节拍�?
	tcnt=0;
